...
//	@Column (name ="sala-consulta")
	...
	public Cadastro (Long id, String nomePaciente, String crmMedico, String nomeMedico, Date dataConsulta, int salaConsulta) {
		this.id = id;
	...
	public static void sort(Comparator<Cadastro> comparing) {
